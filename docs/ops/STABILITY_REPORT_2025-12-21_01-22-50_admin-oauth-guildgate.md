...
- Timestamp: 2025-12-21T01:22:50+00:00
...
M  apps/admin-api/tests/auth/auth-middleware.test.js
 ...
 D apps/admin-ui/pages/guilds/[guildId]/channels.js
 D apps/admin-ui/pages/guilds/[guildId]/corrections.js
 D apps/admin-ui/pages/guilds/[guildId]/index.js
 D apps/admin-ui/pages/guilds/[guildId]/personality.js
 D apps/admin-ui/pages/guilds/[guildId]/rescan.js
 D apps/admin-ui/pages/guilds/[guildId]/settings.js
 D apps/admin-ui/pages/guilds/[guildId]/usage.js
 M apps/admin-ui/pages/guilds/index.js
 M apps/admin-ui/pages/snail/[guildId]/index.js
 M apps/admin-ui/pages/snail/index.js
MM apps/web/Caddyfile.template
...
MM infra/docker/Caddyfile.slimy-nuc2
 M infra/docker/docker-compose.slimy-nuc2.yml
M  scripts/smoke/stability-gate.sh
?? apps/admin-ui/lib/oauth-origin.js
?? apps/admin-ui/lib/settings-tabs.js
?? apps/admin-ui/pages/club/[guildId]/
...
slimy-monorepo-admin-api-1   slimy-monorepo-admin-api   "docker-entrypoint.s…"   admin-api   7 hours ago      Up 7 hours (healthy)    0.0.0.0:3080->3080/tcp, :::3080->3080/tcp
slimy-monorepo-admin-ui-1    slimy-monorepo-admin-ui    "docker-entrypoint.s…"   admin-ui    39 minutes ago   Up 39 minutes           0.0.0.0:3001->3000/tcp, :::3001->3000/tcp
slimy-monorepo-db-1          mysql:8.0                  "docker-entrypoint.s…"   db          33 hours ago     Up 33 hours (healthy)   3306/tcp, 33060/tcp
slimy-monorepo-web-1         slimy-monorepo-web         "docker-entrypoint.s…"   web         30 hours ago     Up 30 hours             0.0.0.0:3000->3000/tcp, :::3000->3000/tcp
```
...
Date: Sun, 21 Dec 2025 01:22:51 GMT
...
X-XSS-Protection: 0
X-Request-ID: 988aa781-f1fe-4e87-a5e3-1aa3a9b2dbde
Vary: Origin
...
```
Location: https://discord.com/oauth2/authorize?client_id=1431075878586290377&redirect_uri=http%3A%2F%2Flocalhost%3A3001%2Fapi%2Fauth%2Fdiscord%2Fcallback&response_type=code&scope=identify+guilds&state=25ecb8760da52cf67090cb7898d0038c&prompt=consent
```
...
PASS tests/auth/active-guild.cookie.test.js
  POST /api/auth/active-guild cookie
    ✓ sets slimy_admin_active_guild_id on success (70 ms)
    ✓ does not set cookie when bot not installed (6 ms)
...
PASS tests/guild-connect.test.js
  POST /guilds/connect
    ✓ should fail if SLIMYAI_BOT_TOKEN is missing (172 ms)
...
PASS tests/auth/me-context.test.js
  GET /api/auth/me Context Hydration
    ✓ should include lastActiveGuild from DB (79 ms)
...
PASS tests/guilds-connect.test.js
  POST /api/guilds/connect
    ✓ should return 200 when connecting with valid frontend payload (72 ms)
    ✓ should return 200 if guild is ALREADY connected (50 ms)
...
PASS tests/auth/active-guild.test.js
  POST /api/auth/active-guild
    ✓ rejects guilds where bot is not installed (O(1) check) (51 ms)
    ✓ returns 503 when bot membership check fails (30 ms)
    ✓ returns 503 when bot token is missing (20 ms)
    ✓ succeeds when bot is installed in guild (8 ms)
    ✓ returns role for primary guild based on policy logic (7 ms)
    ✓ normalizes guildId to string (7 ms)

PASS tests/guilds-read.test.js
  GET /api/guilds/:guildId
    ✓ should return guild details for authenticated user (25 ms)
...
PASS tests/routes/stats.test.js
  Stats Routes
    ...
    ✓ GET /api/stats?action=system-metrics should return metrics (5 ms)
...
PASS tests/central-settings.test.js
  central settings endpoints
    ✓ GET /api/me/settings auto-creates defaults (10 ms)
    ✓ PATCH /api/me/settings merges updates (12 ms)
    ✓ GET /api/guilds/:guildId/settings requires admin/manager (17 ms)
...
PASS tests/auth/auth-middleware.test.js
  Auth Middleware
    resolveUser
      ✓ should return null when no token in cookies (14 ms)
    ...
    requireRole
      ...
      ✓ should call next when user has higher role than required (3 ms)
...
PASS src/lib/auth/post-login-redirect.test.js
  resolvePostLoginRedirectUrl
    ✓ prefers oauth_redirect_uri cookie origin + oauth_return_to (4 ms)
...
PASS tests/discord-guilds.test.js
  GET /discord/guilds
    ✓ should return shared guilds with role labels (31 ms)
...
apps/admin-ui/pages/guilds/[guildId]/channels.js
apps/admin-ui/pages/guilds/[guildId]/corrections.js
apps/admin-ui/pages/guilds/[guildId]/index.js
apps/admin-ui/pages/guilds/[guildId]/personality.js
apps/admin-ui/pages/guilds/[guildId]/rescan.js
apps/admin-ui/pages/guilds/[guildId]/settings.js
apps/admin-ui/pages/guilds/[guildId]/usage.js
...
docs/reports/REPORT_2025-12-20_cors-proxy-audit.md
infra/docker/Caddyfile.slimy-nuc2
