...
- Timestamp: 2025-12-18T17:57:46+00:00
...
Date: Thu, 18 Dec 2025 17:57:47 GMT
...
X-XSS-Protection: 0
X-Request-ID: 668b745f-26c5-4d7b-bc6c-f8c784f40ea3
...
```
Location: https://discord.com/oauth2/authorize?client_id=1431075878586290377&redirect_uri=http%3A%2F%2Flocalhost%3A3001%2Fapi%2Fauth%2Fdiscord%2Fcallback&response_type=code&scope=identify+guilds&state=7e6bf7f512da5ee27847d898f09fe2ad&prompt=consent
```
...
PASS tests/central-settings.test.js
  central settings endpoints
    ✓ GET /api/me/settings auto-creates defaults (55 ms)
...
PASS tests/guilds-connect.test.js
  POST /api/guilds/connect
    ✓ should return 200 when connecting with valid frontend payload (64 ms)
    ✓ should return 200 if guild is ALREADY connected (49 ms)
...
PASS tests/discord-guilds.test.js
  GET /discord/guilds
    ✓ should return shared guilds with role labels (87 ms)
...
PASS tests/guilds-read.test.js
  GET /api/guilds/:guildId
    ...
    ✓ should return 404 for non-existent guild (18 ms)
...
PASS tests/auth/auth-middleware.test.js
  Auth Middleware
    resolveUser
      ✓ should return null when no token in cookies (99 ms)
      ✓ should return null when token is invalid (9 ms)
      ✓ should return hydrated user when session exists (9 ms)
      ✓ should return fallback user when no session exists (7 ms)
      ✓ should cache user resolution (7 ms)
    requireAuth
      ✓ should call next when user is authenticated (28 ms)
    ...
    requireRole
      ...
      ✓ should return 401 when user is not authenticated (12 ms)
    requireGuildMember
...
PASS tests/numparse.test.js
  numparse shim
    ✓ returns numeric values for plain numbers (3 ms)
    ✓ returns null for non-numeric values or suffixed strings (1 ms)

PASS tests/routes/stats.test.js
  Stats Routes
    ✓ GET /api/stats should return system metrics by default (17 ms)
...
PASS tests/middleware/rbac.test.js
  requireGuildAccess Middleware
    ...
    ✓ should return 403 if user not found in DB (9 ms)
