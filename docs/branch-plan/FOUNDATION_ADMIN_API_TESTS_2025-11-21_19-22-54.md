...
- Timestamp: Fri, 21 Nov 2025 19:22:54 -0500
...
- @slimy/admin-api: ❌ 3 suites failed / 1 passed. Auth middleware suite now passes. Remaining failures due to missing dependency  when loading @slimy/core from vendor bundle (affects auth-routes.test.js, diag.test.js, auth-and-guilds.test.js).
...
- Provide or mock  for @slimy/core, or adjust module resolution for admin-api tests.
...
apps/admin-api test: Time:        1.362 s
