...
const slimecraftStatusHistoryRoutes = require("./slimecraft-status-history");
const slimecraftBackupsRoutes = require("./slimecraft-backups");
...
router.use("/api/slimecraft/status-history", slimecraftStatusHistoryRoutes);
router.use("/api/slimecraft/backups", slimecraftBackupsRoutes);
