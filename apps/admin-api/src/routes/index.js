...
const slimecraftPlayersRoutes = require("./slimecraft-players");
const slimecraftPlayerStatsRoutes = require("./slimecraft-player-stats");
...
router.use("/api/slimecraft/players", slimecraftPlayersRoutes);
router.use("/api/slimecraft/player-stats", slimecraftPlayerStatsRoutes);
